...
export const sceneTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    kind: "scene",
    description:
      "Send the user to another Blueprint view: gt3rs_car (full GT3 RS), gt3rs_engine (flat-six teardown), tourbillon_engine (W16).",
    parameters: {
      destination: {
        type: "string",
        description: "Destination view.",
        enum: ["gt3rs_car", "gt3rs_engine", "tourbillon_engine"],
        required: true,
      },
    },
  },
